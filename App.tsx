...
function App(): JSX.Element {
  ...
  return (
    ...
    ,
       ...
       <Stack.Screen name='VerifyQr' component={VerifyQr} options={{title:"Verify QR Code",headerLeft:()=>
    <View><Text style={styles.dot}>.</Text></View>}} />
       <Stack.Screen name='PrintTest' component={PrintTest} options={{title:"Print Test"}} />
       <Stack.Screen name='CapturePhoto' component={CapturePhoto} options={{title:"Capture Photo"}} />
       <Stack.Screen name='ScanForGenerate' component={ScanForGenerate} options={{title:"Scan QR"}} />
